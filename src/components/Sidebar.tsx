  ...
  return <Conatiner>
        <div className="container">
            <div className={!open ? "back-screen active":"back-screen"}>
                <BsArrowLeftShort className={!open ? "bg-icon rotate" : "bg-icon"}onClick={changeSideButton} />
                <div className="logo">
            ...
            <ul className="menu">
                {menuItems.map((menu,index)=>(
                    ...
                    <NavLink to={menu.path} className={`menuItems ${menu.spacing ? "spacingLg":"spacingMd"}`}>
                ...
                {menu.submenu && open && (
                    <BsChevronDown className={subMenuOpen ? "dropdown rotate-180":"dropdown"} onClick={()=>setSubMenuOpen(!subMenuOpen)}/>
                    ...
                    {menu.submenu && subMenuOpen && open &&(
                        <ul>
                            {menu.submenuItems.map((submenuItem,index)=>(
                                <NavLink to={submenuItem.path} key={index} className="menuItems submenu">
